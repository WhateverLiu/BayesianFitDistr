...
RcppExport SEXP sourceCpp_60_mixDistrList(SEXP XSEXP, SEXP YSEXP, SEXP rstSizesSEXP, SEXP YweightsSEXP, SEXP regridMethodSEXP, SEXP maxCoreSEXP) {
BEGIN_RCPP
...
RcppExport SEXP sourceCpp_60_mixDistr(SEXP XSEXP, SEXP YSEXP, SEXP rstSizeSEXP, SEXP yweightSEXP, SEXP regridMethodSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< List >::type X(XSEXP);
