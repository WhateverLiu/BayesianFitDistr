...
RcppExport SEXP sourceCpp_15_igscore(SEXP XSEXP, SEXP xSEXP, SEXP redistributePwithinSEXP) {
BEGIN_RCPP
...
RcppExport SEXP sourceCpp_15_igscoreMean(SEXP XSEXP, SEXP truePMFSEXP, SEXP redistributePwithinSEXP, SEXP symmetricScoreSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< List >::type X(XSEXP);
