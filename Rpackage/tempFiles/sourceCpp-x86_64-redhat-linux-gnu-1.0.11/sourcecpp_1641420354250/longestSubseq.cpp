...
IntegerVector longestIncreasingSubseqSlow(NumericVector x);
RcppExport SEXP sourceCpp_19_longestIncreasingSubseqSlow(SEXP xSEXP) {
BEGIN_RCPP
...
IntegerVector longestIncreasingSubseq(NumericVector x);
RcppExport SEXP sourceCpp_19_longestIncreasingSubseq(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type x(xSEXP);
...
IntegerVector longestNonDecreasingSubseq(NumericVector x);
RcppExport SEXP sourceCpp_19_longestNonDecreasingSubseq(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type x(xSEXP);
