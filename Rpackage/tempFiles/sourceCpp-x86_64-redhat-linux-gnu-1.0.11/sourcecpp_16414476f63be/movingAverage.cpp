...
RcppExport SEXP sourceCpp_25_movingAverage(SEXP xSEXP, SEXP windowSizeSEXP, SEXP speedSEXP, SEXP returnWindowsSEXP) {
BEGIN_RCPP
...
NumericVector movingAverageSmoothing(NumericVector x, int windowSize, int iterations);
RcppExport SEXP sourceCpp_25_movingAverageSmoothing(SEXP xSEXP, SEXP windowSizeSEXP, SEXP iterationsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type x(xSEXP);
...
RcppExport SEXP sourceCpp_25_windowVariances(SEXP xSEXP, SEXP windowSizePercentageIncrementSEXP, SEXP maxCoreSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type x(xSEXP);
